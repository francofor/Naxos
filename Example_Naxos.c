...
int main()
{
  ...
  for (z=0;z<4;z++)
  {
	...
	*/
    ...
    if (publicKey(pkAx,pkAy,skA,&curveN)!=0)  /* Calculate pkA from skA                                          */
    {
      printf("Invalid skA: it is 0 or >= p\n");
      return -1;
	...
	*/
    ...
    if (publicKey(pkBx,pkBy,skB,&curveN)!=0)  /* Calculate pkB from skB                                          */
    {
      printf("Invalid skB: it is 0 or >= p\n");
      return -1;

	}

    printf("PKI distributes identities and keys\n");
	...
	*/
    ...
    switch(res)
      {
        case -1:
          printf("Invalid pkA: it is not mod p\n");
          return -1;

        case -2:
          printf("Invalid pkA: it is not on the curve\n");
          return -1;
    ...
    if (res==1)
    {
    	printf("Successful, kA=kB \n");
    }
    else
    {
    	printf("Unsuccessful, kA!=kB \n");
    }
    printf("\n\n");
  }
